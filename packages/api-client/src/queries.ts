...
export const queryKeys = {
  ...
  me: ['me'] as const,
  bookingStanding: (salonId: string) => ['me', 'booking-standing', salonId] as const,
  ...
  pro: {
    ...
    clientsPage: (q: string) => ['pro', 'clients', 'page', q] as const,
  ...
  return {
    ...
    wilayas: () =>
      queryOptions({
        ...
        queryFn: () => api.public.wilayas(),
        staleTime: Infinity,
      }),
    salons: (q: Partial<SearchSalonsQuery>) =>
      queryOptions({
        queryKey: queryKeys.salons(q),
        queryFn: () => api.public.searchSalons(q),
        staleTime: 2 * MIN,
      }),
    cities: (q: Parameters<typeof api.public.cities>[0]) =>
      queryOptions({
        queryKey: queryKeys.cities(q),
        queryFn: () => api.public.cities(q),
        staleTime: 10 * MIN,
      }),
    suggest: (q: Parameters<typeof api.public.suggest>[0]) =>
      queryOptions({
        queryKey: queryKeys.suggest(q),
        queryFn: () => api.public.suggest(q),
        staleTime: 5 * MIN,
      }),
    salon: (slug: string) =>
      queryOptions({
        queryKey: queryKeys.salon(slug),
        queryFn: () => api.public.salon(slug),
        staleTime: 5 * MIN,
        enabled: !!slug,
      }),
    ...
    reviews: (salonId: string) =>
      queryOptions({
        queryKey: queryKeys.reviews(salonId),
        queryFn: () => api.public.reviews(salonId),
        staleTime: 5 * MIN,
        enabled: !!salonId,
      }),
    me: () =>
    ...
    bookingStanding: (salonId: string) =>
      queryOptions({
        queryKey: queryKeys.bookingStanding(salonId),
        queryFn: () => api.me.bookingStanding(salonId),
        staleTime: 30_000,
        retry: false,
        enabled: !!salonId,
      }),
    ...
    myBookings: (q: Partial<MyBookingsQuery> = {}) =>
      queryOptions({
        queryKey: queryKeys.myBookings(q),
        queryFn: () => api.bookings.mine(q),
        staleTime: 30_000,
      }),
    booking: (id: string) =>
      queryOptions({
    ...
    pro: {
      salon: () =>
        queryOptions({
          queryKey: queryKeys.pro.salon,
          queryFn: () => api.pro.salon(),
          staleTime: 2 * MIN,
          retry: false,
        }),
      clients: () =>
        queryOptions({
          queryKey: queryKeys.pro.clients,
          queryFn: () => api.pro.clients.list({ limit: 100 }),
          staleTime: MIN,
        }),
      client: (key: string) =>
        queryOptions({
          queryKey: queryKeys.pro.client(key),
          queryFn: () => api.pro.clients.one(key),
          staleTime: MIN,
          enabled: !!key,
        }),
      clientHistory: (key: string) =>
        queryOptions({
          queryKey: queryKeys.pro.clientHistory(key),
          queryFn: () => api.pro.clients.history(key),
          staleTime: MIN,
        }),
      stats: () =>
        queryOptions({
          queryKey: queryKeys.pro.stats,
          queryFn: () => api.pro.stats(),
          staleTime: 30_000,
        }),
      statsRange: (from: string, to: string) =>
        queryOptions({
          queryKey: queryKeys.pro.statsRange(from, to),
          queryFn: () => api.pro.statsRange(from, to),
          staleTime: 30_000,
        }),
      bookings: (q: Partial<ListBookingsQuery> = {}) =>
        queryOptions({
          queryKey: queryKeys.pro.bookings(q),
          queryFn: () => api.pro.bookings.list(q),
          staleTime: 15_000,
        }),
      pending: () =>
        queryOptions({
      ...
      booking: (id: string) =>
        queryOptions({
          queryKey: queryKeys.pro.booking(id),
          queryFn: () => api.pro.bookings.get(id),
          enabled: !!id,
        }),
      blocks: (from?: string, to?: string) =>
        queryOptions({
          queryKey: queryKeys.pro.blocks(from, to),
          queryFn: () => api.pro.blocks.list(from, to),
          staleTime: MIN,
        }),
      staffHours: (id: string) =>
        queryOptions({
          queryKey: queryKeys.pro.staffHours(id),
          queryFn: () => api.pro.staff.hours(id),
          enabled: !!id,
        }),
    },
  };
