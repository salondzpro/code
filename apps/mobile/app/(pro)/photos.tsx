...
import { Camera, Plus, Star, Trash2, X } from 'lucide-react-native';
...
export default function ProPhotos() {
  ...
  const addPhotos = async () => {
    setError(null);
    try {
      // Une photo à la fois : l'éditeur natif permet de la positionner dans le cadre avant de valider.
      const imgs = await pickImages({ aspect: COVER_ASPECT_RN });
