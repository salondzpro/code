  ...
  return (
    <Screen gap={13}>
      ...
      <Card gap={13} style={{ alignItems: 'center', paddingVertical: 13 }}>
        <Pressable accessibilityRole="button" accessibilityLabel="Agrandir le QR code" onPress={() => router.push('/qr')} style={{ width: 276, maxWidth: '100%', aspectRatio: 1, borderRadius: R.card, backgroundColor: C.fill, alignItems: 'center', justifyContent: 'center' }}>
