  ...
  if (geo === 'denied' && choice.kind === 'gps' && prefs.lat == null) {
    ...
    return (
      <Screen gap={13}>
        ...
        <Card row gap={13}>
          <View style={{ width: 34, height: 34, borderRadius: R.card, backgroundColor: C.fill, alignItems: 'center', justifyContent: 'center' }}>
      ...
      {searching ? (
        ...
        <>
          <Card row gap={13} sel={choice.kind === 'gps'} onPress={() => (pos ? setChoice({ kind: 'gps' }) : void locate())} accessibilityLabel="Utiliser ma position actuelle">
            <View style={{ width: 42, height: 42, borderRadius: R.card, backgroundColor: C.ink, alignItems: 'center', justifyContent: 'center' }}>
