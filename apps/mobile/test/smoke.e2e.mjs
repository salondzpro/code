 ...
 *
 * Prérequis : `pnpm dev:api` (port 8090) et, depuis `apps/mobile` :
 *   CI=1 EXPO_PUBLIC_API_URL=http://localhost:8090 npx expo start --web --port 8082 --clear
 ...
 * Variables  : `MOBILE_WEB` (défaut http://localhost:8082), `API_URL` (défaut http://localhost:8090).
 *
