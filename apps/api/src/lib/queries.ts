...
export const BOOKING_COLS =
  'id, salon_id, client_id, staff_id, service_id, service_name, duration_minutes, price_da, starts_at, ends_at, status, source, client_name, client_phone, notes, cancelled_at, cancelled_by, cancellation_reason, cancellation_kind, client_reschedules, created_at, updated_at';
