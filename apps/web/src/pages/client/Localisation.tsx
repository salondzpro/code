  ...
  return (
    <Screen bottom={SHEET_PAD} gap={16}>
      ...
      <div className="relative h-[10rem] overflow-hidden rounded-[1.25rem] border border-line bg-fill">
        ...
        <span className="absolute bottom-4 left-6 rounded-full bg-surface px-4 py-2 text-[0.8125rem] font-semibold shadow-card">Rayon de {radius} km</span>
      </div>
          ...
          return (
            ...
            >
              <span className="flex items-center gap-3.5">
                ...
                <span>
                  <span className={`block text-[1rem] font-semibold ${on ? '' : 'text-muted'}`}>{c.city}</span>
      ...
      <BottomSheet>
        <div className="flex items-center justify-between gap-3">
          <div>
            <div className="text-[1.125rem] font-bold tracking-[-0.4px]">
