                ...
                <div key={sv.id} className={`li !py-3 ${sv.isActive ? '' : 'opacity-60'}`}>
                  ...
                  >
                    {photo ? (
                      <Img
                        src={photo}
                        className="h-[3.75rem] w-[3.75rem] flex-none !rounded-[var(--radius-card-sm)]"
                      />
                    ) : (
                      <button
                        type="button"
                        className="flex h-[3.75rem] w-[3.75rem] flex-none items-center justify-center rounded-[var(--radius-card-sm)] border border-dashed border-line bg-fill text-subtle"
