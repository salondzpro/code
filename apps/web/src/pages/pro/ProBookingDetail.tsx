    ...
    <Screen bottom={SHEET_PAD} gap={16}>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="min-w-0">
          ...
          {b.clientPhone && <p className="mt-1 text-[0.8125rem] text-muted">{formatDZPhone(b.clientPhone)}</p>}
    ...
    <Screen bottom={SHEET_PAD} gap={16}>
      ...
      <div className="crd !gap-0 !py-1">
        <label className="li !py-4">
          ...
          <input type="date" className="bg-transparent text-right text-[0.9375rem] outline-none" value={d} min={toLocalDateKey()} onChange={(e) => setDate(e.target.value)} aria-label="Nouvelle date" />
        </label>
        <label className="li !py-4">
          <span className="text-[0.9375rem]">Heure</span>
          <input type="time" step={300} className="bg-transparent text-right text-[0.9375rem] outline-none" value={t} onChange={(e) => setTime(e.target.value)} aria-label="Nouvelle heure" />
        </label>
        {staff.length > 1 && (
          <label className="li !py-4">
