 ...
 * « Ouvrir mon espace pro » si déjà connecté), puis les avantages et les quatre étapes.
 */
  ...
  return (
    <div className="rd flex min-h-dvh flex-col">
      ...
      <div className="flex flex-1 flex-col gap-5 px-5 pb-8 pt-5">
        {/* Le choix d'abord : créer son espace, ou se connecter. Déjà connecté avec un compte client :
            le bouton ouvre directement l'espace professionnel. */}
