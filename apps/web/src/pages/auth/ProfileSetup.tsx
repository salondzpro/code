    ...
    <Screen className="min-h-dvh" gap={16}>
      ...
      <form onSubmit={submit} className="flex flex-col gap-5">
        ...
        <div>
          ...
          <div className="flex items-center justify-between rounded-[var(--radius-card-sm)] bg-fill px-4 py-[1.125rem] text-[0.857rem]">
        ...
        <div className="flex items-center justify-between">
          <span>
            <span className="block text-[1rem] font-semibold">Rappels WhatsApp</span>
