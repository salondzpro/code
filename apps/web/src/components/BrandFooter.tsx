...
export function BrandFooter() {
  ...
  return (
    <div className="mt-6 flex flex-col items-center gap-1.5 pb-2 text-center" aria-label="Salon DZ">
      ...
      <div className="mono text-[0.857rem] tracking-[0.26em] text-subtle">RÉSERVATION EN LIGNE</div>
      <div className="text-[0.857rem] text-subtle">© {year} Salon DZ · Fait en Algérie</div>
    </div>
  );
}
